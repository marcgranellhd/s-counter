...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-border/50 bg-muted/20 font-medium", className)}
    {...props}
  />
));
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/40 transition-colors hover:bg-accent/20 data-[state=selected]:bg-accent/20",
      className
    )}
    {...props}
  />
